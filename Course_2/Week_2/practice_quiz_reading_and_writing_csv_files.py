...
# This quesion returns:
# Something went wrong! Contact Coursera Support about this question!

# 2. Using the CSV file of flowers again, fill in the gaps of the
...
# 3. In order to use the writerows() function of DictWriter() to write a list
# of dictionaries to each line of a CSV file, what steps should we take? (Check
# all that apply)
#
...
# 4. Which of the following is true about unpacking values into variables when
# reading rows of a CSV file? (Check all that apply)
#
# [X] We need the same amount of variables as there are columns of data in the
# CSV
...
# 5. If we are analyzing a file's contents to correctly structure its data,
