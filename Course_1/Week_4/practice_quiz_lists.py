...
newfilenames = [filename.replace("hpp", "h") if filename.endswith(
...
# Or it can be written with a string using the letters r, w, and x or - when
# the permission is not granted. For example: 640 is read/write for the owner,
# read for the group, and no permissions for the others; converted to a
# string, it would be: "rw-r-----" 755 is read/write/execute for the owner,
# and read/execute for group and others; converted to a string, it would be:
# "rwxr-xr-x" Fill in the blanks to make the code convert a permission in
...
# out: Ken is 30 years old and works as Chef. Pat is 35 years old and works
# as Lawyer. Amanda is 25 years old and works as Engineer. Fill in the gaps
# in this function to do that.

def guest_list(guests):
    for name, age, career in guests:
