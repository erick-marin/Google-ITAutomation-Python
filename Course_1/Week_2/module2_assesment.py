...
# Currently, it only supports the three additive primary colors (red, green,
...
# "Fail". In addition, scores above 95 (not included) are graded as "Top
...
# first_name and last_name parameters and then returns a properly formatted
# string.

# Specifically:

# If both the last_name and the first_name parameters are supplied, the
# function should return like so:
#
#print(format_name("Ella", "Fitzgerald"))
# Name: Fitzgerald, Ella
#
# If only one name parameter is supplied (either the first name or the last
# name) , the function should return like so:
#
...
# Name: Einstein
# Finally, if both names are blank, the function should return the empty
# string:
#
# print(format_name("", ""))
#
...
# Question 7
# The longest_word function is used to compare 3 words. It should return the
# word with the most number of characters (and the first in the list when they
# have the same length). Fill in the blank to make this happen.
...
# body of the function so that it returns the right number. Note: Since
# division by 0 produces an error, if the denominator is 0, the function
# should return 0 instead of attempting the division.

def fractional_part(numerator, denominator):
    # Operate with numerator and denominator to keep just the fractional part
    # of the quotient
