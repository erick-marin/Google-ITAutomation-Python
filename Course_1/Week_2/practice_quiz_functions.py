...
# 4. Calculate the round-trip in kilometers by doubling the result, and fill
...
#
# Hint: if a function returns multiple values, don't forget to store these
...
# 1) Fill in the blanks so the print statement displays the result of the
# function call
